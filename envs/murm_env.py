...
class MURMENV(PandaBaseEnv):
    ...
    def __init__(self,
        ...
        self._object_position_low = (0.4, -0.2, 1)
        self._object_position_high = (0.8, 0.2, 1.5)
        self._tray_position_low = (.65, -0.15, -.35)
        self._tray_position_high = (.75, 0.15, -.35)
        self._goal_low = np.array([0,-0.2, 1])
        self._goal_high = np.array([0.6,0.2, 1.5])
        ...
        self._view_matrix_obs = bullet.get_view_matrix(
            target_pos=[0.6, 0, 1], distance=0.35,
    ...
    def reset(self, change_object=True):
        ...
        bullet.position_control(self._panda, self._end_effector, init_pos, self.default_theta)
    ...
    def _load_table(self):
        ...
        #Need quite random placement of cube(object)
        self.objectcube = bullet.objects.cube()
    ...
    def enforce_bounding_box(self):
        ...
        if not contained:
            bullet.position_control(self._panda, self._end_effector,
    ...
    def step(self, *action):
        ...
        curr_angle = bullet.get_link_state(self._panda, self._end_effector, 'theta')

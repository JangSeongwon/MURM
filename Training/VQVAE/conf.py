# Change these things
CODE_DIRS_TO_MOUNT = [
    '/home/jang/PycharmProjects/rlkit/rlkit',
    '/home/jang/PycharmProjects/rlkit/doodadmaster',
    '/home/jang/PycharmProjects/rlkit/multiworld',
]
DIR_AND_MOUNT_POINT_MAPPINGS = [
    dict(
        local_dir='/home/jang/.mujoco/',
        mount_point='/root/.mujoco',
    ),
]
LOCAL_LOG_DIR = 'dataSaving'
RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    '/home/PycharmProjects/rlkit/scripts/run_experiment_from_doodad.py'
)

...
class VQ_VAETrainer(ConvVAETrainer, LossFunction):
    ...
    def train_epoch(self, epoch, dataset, batches=1):
    ...
    def train_batch(self, epoch, batch):
        ...
        #print('epoch', epoch)
        #print('loss of VQ_VAE', loss, loss.shape)
    ...
    def compute_loss(self, batch, epoch=-1, test=False):
        ...
        vq_loss, data_recon, recon_error = self.model.compute_loss(obs)

        latent_loss_weight = 0.25 #1

...
class MURMENV(PandaBaseEnv):
    ...
    def __init__(self,
        ...
        self._pos_low = [0.175, -0.6, 1.0]
        self._pos_high = [0.625, 0.1, 1.3]
    ...
    def run_for_goal2(self):
        ...
        final_pos = self.goal_pos + np.array([-0.075, 0, 0.05])
...
##############################################################################################
    ...
    def my_action(self, goal):
        ...
        on_drop_height = 0.07 < target_pos[2] - goal[2] < 0.1
        ...
        if done and 11 > self.time_add > 7:

...
class PandaBaseEnv(gym.Env, Serializable):
    ...
    initial_positions = {
        'panda_joint1': 0.06721909047316917, 'panda_joint2': -0.2663069276814615, 'panda_joint3': -0.07003360745397018,
        'panda_joint4': -2.6865532839799657, 'panda_joint5': -0.02789899273729828, 'panda_joint6': 2.4206622583514372,
        'panda_joint7': 0.8060038909156075, 'panda_finger_joint1': 0.04, 'panda_finger_joint2': 0.04,
    }

    # initial_positions = {
    #     'panda_joint1': 0.05, 'panda_joint2': -0.5, 'panda_joint3': -0.07,
    #     'panda_joint4': -2.95, 'panda_joint5': -0.06, 'panda_joint6': 2.4,
    #     'panda_joint7': 0.81, 'panda_finger_joint1': 0.04, 'panda_finger_joint2': 0.04,
    # }
    def __init__(self,
                 img_dim=64,
                 gui=False,
    ...
    def pre_grasp(self):
        self.apply_action_fingers([0.04, 0.04], force=15)

...
ASSET_PATH = os.path.join('/home/jang/PycharmProjects/murm_env_previous/roboverse/envs/assets/bulletobjects/')
ASSET_PATH_ORI = os.path.join('/home/jang/PycharmProjects/murm_env_previous/roboverse/envs/assets/')
PDATA_PATH = pdata.getDataPath()
Robot_path = os.path.join('/home/jang/PycharmProjects/murm_env_previous/roboverse/envs/assets/Panda_robot/urdf/panda.urdf')

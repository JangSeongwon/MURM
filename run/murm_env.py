...
class MURMENV(PandaBaseEnv):
    ...
    def reset(self, change_object=False):
        ...
        self._panda = p.loadURDF(os.path.join('/home/jang/PycharmProjects/murm_env_previous/roboverse/envs/assets/Panda_robot/urdf/panda.urdf'),
        ...
        # run_for_goal = self.run_for_goal2()
        # print('IK Calculation', run_for_goal)
